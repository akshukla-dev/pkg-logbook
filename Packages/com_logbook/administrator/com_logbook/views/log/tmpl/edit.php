...
<form action="<?php echo JRoute::_('index.php?option=com_logbook&layout=' . $layout . $tmpl . '&id=' . (int) $this->item->id); ?>" method="post" name="adminForm" id="log-form" class="form-validate">
		...
		<div class="row-fluid">
			<div class="span9">
				<div class="form-vertical">
					...
					<?php echo $this->form->getControlGroup('upload_log'); ?>
				</div>
			</div>
			<div class="span3">
