...
abstract class LogbookHelperRoute
{
  ...
  /**
   * @param   integer  The route of the log
   */
  public static function getDocumentRoute($id, $wdid, $language = 0)
  {
  ...
  /**
   * @param   integer  $id		The id of the log.
  ...
  public static function getFormRoute($id, $return = null)
  {
    // Create the link.
    if($id) {
      $link = 'index.php?option=com_logbook&task=log.edit&d_id='.$id;
    }
    else {
      $link = 'index.php?option=com_logbook&task=log.add&d_id=0';
    }
