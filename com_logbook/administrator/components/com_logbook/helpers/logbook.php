...
class LogbookHelper extends JHelperContent
{
    ...
    public static function addSubmenu($vName = 'logs')
    {
        ...
        JHtmlSidebar::addEntry(
            JText::_('COM_LOGBOOK_SUBMENU_AUDITS'),
            'index.php?option=com_logbook&view=audits',
            $vName == 'audits'
        );
    ...
    /**
     * Adds Count Items for logs Category Manager.
     *
     ...
     *
     * @param stdClass[] &$items    The log tag objects
