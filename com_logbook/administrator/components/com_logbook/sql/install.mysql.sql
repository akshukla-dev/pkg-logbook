...
CREATE TABLE IF NOT EXISTS `#__logbook_logs`(
  ...
  `file_type` TINYTEXT NOT NULL DEFAULT '',
  `file_size` TINYTEXT NOT NULL DEFAULT '',
  `file_path` TINYTEXT NOT NULL DEFAULT '',
  `file_icon` TINYTEXT NOT NULL DEFAULT '',
