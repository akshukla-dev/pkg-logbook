 ...
 * @since  1.5
 */
class LogbookViewSchedule extends JViewLegacy
{
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolbarHelper::title($isNew ? JText::_('COM_LOGBOOK_MANAGER_SCHEDULE_NEW') : JText::_('COM_LOGBOOK_MANAGER_SCHEDULE_EDIT'), 'schedule schedules');
		...
		{
			JToolbarHelper::save2copy('schedule.save2copy');
		}
		...
		else
		{
			...
			{
				JToolbarHelper::versions('com_logbook.schedule', $this->item->id);
			}
		...
		JToolbarHelper::help('JHELP_COMPONENTS_LOGBOOK_SCHEDULE_EDIT');
	}
}
