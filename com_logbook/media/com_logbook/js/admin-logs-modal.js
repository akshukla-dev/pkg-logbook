...
(function() {
	 ...
	 * View element calls jSelectLog when an Log is clicked
	 * jSelectLog creates the link tag, sends it to the editor,
	 * and closes the select frame.
	 **/
	window.jSelectLog = function (id, title, catid, object, link, lang) {
		var hreflang = '', editor, tag;

		if (!Joomla.getOptions('xtd-logs')) {
			// Something went wrong!
			window.parent.jModalClose();
			return false;
		}

		editor = Joomla.getOptions('xtd-logs').editor;
