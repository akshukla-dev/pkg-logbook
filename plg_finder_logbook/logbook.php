 ...
 * @since  2.5
 */
class PlgFinderLogbook extends FinderIndexerAdapter
{
	/**
	 ...
	 * @since  2.5
	 */
	protected $extension = 'com_logbook';
	 ...
	 * @since  2.5
	 */
	protected $table = '#__logbook_logs';
	...
	{
		// Make sure we're handling com_logbook categories.
		if ($extension == 'com_logbook')
		{
	 ...
	 * Reindexes the link information for a log that has been saved.
	 * It also makes adjustments if the access level of a log item or
